...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <commands EXPORT="discard">make udp-client-static.sky TARGET=sky WITH_COMPOWER=1 SEED=SCRIPT_SEED PERIOD=SCRIPT_PERIOD RPL_CONF_FIXED_DIO=SCRIPT_RPL_CONF_FIXED_DIO RPL_CONF_DIO_ON_INCONSISTENCY=SCRIPT_RPL_CONF_DIO_ON_INCONSISTENCY RPL_CONF_DIO_DAO_ON_NEW_PARENT=SCRIPT_RPL_CONF_DIO_DAO_ON_NEW_PARENT RPL_CONF_PROBE_ON_NEW_NEIGHBOR=SCRIPT_RPL_CONF_PROBE_ON_NEW_NEIGHBOR RPL_CONF_REVERSE_TRICKLE=SCRIPT_RPL_CONF_REVERSE_TRICKLE RPL_CONF_AVOID_MOBILE=SCRIPT_RPL_CONF_AVOID_MOBILE PROJ_DIR=SCRIPT_SIMULATION_NAME </commands>
