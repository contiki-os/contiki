...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <commands EXPORT="discard">make udp-client.sky TARGET=sky WITH_COMPOWER=1 PERIOD=20 RPL_CONF_FIXED_DIO=0 RPL_CONF_DIO_ON_INCONSISTENCY=0 RPL_CONF_DIO_DAO_ON_NEW_PARENT=0 RPL_CONF_PROBE_ON_NEW_NEIGHBOR=0 </commands>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <random_offset>10</random_offset>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>
var folder="/Users/Brian/git/contiki-lit/contiki/examples/rpl-mobility";
...
var finalFile = new java.io.FileWriter(folder + "/log_final.log",true);
...
while(1) {
    ...
    if(sim.getSimulationTimeMillis() > 1200000 - 10000){
      endCalculations();
      closeFiles();
      log.testOK();
    }
    ...
    if(msg.startsWith("{")) {
      ...
      if(msgArray[2] == "P"){
        energyFile.write( sim.getSimulationTime() + " " + 
            id + " " + msgArray[5] + " " + msgArray[6] + " " + msgArray[7] + 
