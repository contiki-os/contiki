 ...
 */
#define OTA_IMAGE_1_OFFSET        0x1000  //  The "Golden Image" initial OTA firmware provided on the chip
#define OTA_IMAGE_2_OFFSET        0x8000  //  Our first OTA version upgrade
...
main(void)
{
  jump_to_image(OTA_IMAGE_1_OFFSET + OTA_IMAGE_HEADER_LENGTH + OTA_IMAGE_RESET_VECTOR);
  return 0;
}
