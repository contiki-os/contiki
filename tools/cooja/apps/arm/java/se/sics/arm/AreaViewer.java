...
import se.sics.arm.AdvancedRadioMedium.*;

/**
 * The class AreaViewer belongs to the Advanced Radio Medium (ARM) package.
 * 
 ...
 * 
 * For more information about ARM see @link AdvancedRadioMedium.
 * 
 * @see AdvancedRadioMedium
 * @author Fredrik Osterlind
 */
@ClassDescription("ARM - Area Viewer")
...
public class AreaViewer extends VisPlugin {
   ...
   * 
   * @param simulationToVisualize Simulation using Advanced Radio Medium
   */
  public AreaViewer(Simulation simulationToVisualize) {
    super("Advanced Radio Medium - Area Viewer");
