...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/regression-tests/26-6tisch/code/test-sixp-trans.c</source>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONTIKI_DIR]/regression-tests/26-6tisch/js/unit-test.js</scriptfile>
      <active>true</active>
    </plugin_config>
    <width>495</width>
    <z>0</z>
