...
static void
uli2a(unsigned long num, unsigned long base, int uc, char *bf_out)
{
  int n = 0;
  unsigned long d = 1;
  char bf_tmp[12];
...
static void
f2a(double num, int decimals, char *bf)
{
  int i;
  int length;
  char prev = '.';
...
static void
ui2a(unsigned int num, unsigned int base, int uc, char *bf_out)
{
  int n = 0;
  unsigned int d = 1;
  char bf_tmp[12];
