...
//
// ds18b20_get_temp returns the temperature in "temperature"
// Returns 0 on failure (and then "temperature" is left unchanged
// Returns 1 on success, and sets temperature
//

uint8_t  ds18b20_get_temp(int16_t *temperature)
{
  uint8_t result = 0;
